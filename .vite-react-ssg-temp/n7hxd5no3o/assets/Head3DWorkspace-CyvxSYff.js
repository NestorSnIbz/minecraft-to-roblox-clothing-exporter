...
import { a as exportToOBJClassic, i as dilateTexture, n as buildReliefExportGroup, o as exportToOBJWithRelief, r as buildVoxelizedOverlay, t as buildBaseHead } from "./OBJExporter-BmA7_eVA.js";
...
function buildVoxelizedOverlayWithRelief(skinImage, heightmap) {
	...
	faces.forEach((face) => {
		for (let row = 0; row < 8; row++) for (let col = 0; col < 8; col++) {
			...
			const geom = buildBoxGeometry(clipW ? CORNER_CLIP_W : pixelSize, clipH ? CORNER_CLIP_W : pixelSize, THICKNESS, info.uMin, info.uMax, info.vMin, info.vMax);
